...
app.get('/', (req, res) => {
  const INSTAGRAM_AUTH_URL = `https://api.instagram.com/oauth/authorize?client_id=3544442045867062&redirect_uri=https://codms7870.github.io/my-first-web-site/&scope=user_profile,user_media&response_type=code`;
